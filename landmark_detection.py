...
class PoseEstimation():
    ...
    def __init__(self):
        ...
        self.w_integrated = np.array([[612., 0, 313], [0, 612, 248], [0, 0, 1]])
    ...
    def weakLinear_Alpha(self, pts2d, angle, lambda1, lambda2, T):
        ...
        return alpha
    def get_T(self, pts_2d):
        pts_3d = self.DM['mu'].reshape((-1, 3))
        _, _, tvec = cv2.solvePnP(pts_3d, pts_2d, self.w_integrated, distCoeffs=(0, 0, 0, 0))
        return tvec*np.sign(tvec[-1]) 
#%%
    ...
    def face_detect(self, img):
        ...
        for idx in np.arange(bboxes.shape[0]):
            ...
            try:
                ...
                _, _, confidence = predict([0], [descriptor], self.face_detector['confidence_LBP']['model'], '-b 1')
